...
using namespace std;
class SVLaserScannerSerialComm :public CObject
{	
	DECLARE_DYNCREATE(SVLaserScannerSerialComm)
private:
	CCriticalSection m_CriticalSection;

public:
	SVLaserScannerSerialComm();
	virtual ~SVLaserScannerSerialComm();
...
DWORD CommWatchProcForSVLaserScanner(LPVOID lpData);
